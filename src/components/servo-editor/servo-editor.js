...
class ServoEditor extends Component {
  ...
  init () {
    ...
    this.createSlider("id-1-angle", [0, 180]);
    this.createSlider("id-2-motor");
    this.createSlider("id-2-angle", [0, 180]);

    this.createSlider("id-3-motor");
    this.createSlider("id-3-angle", [0, 180]);
    this.createSlider("id-4-motor");
    this.createSlider("id-4-angle", [0, 180]);
  }
      ...
      <section className="box control-mode servo-editor">
        ...
        <div className="box-content control-content">
          ...
          <div className="wrapper slider-wrapper">
            ...
            <div className="slider-box angle">
              <div className="slider" id="id-3-motor"></div>
              <div className="slider" id="id-3-angle"></div>
              <div className="slider" id="id-4-motor"></div>
              <div className="slider" id="id-4-angle"></div>
            </div>
          </div>
